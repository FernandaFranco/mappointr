class GamesController < ApplicationController
  ...
  def show
    ...
    # Todo chute já feito neste país, anônimo (ver GameRound.guess_points),
    # um ponto no mapa por chute. Só faz sentido mostrar junto com a
    # comparação: sem outros chutes, seria só o próprio ponto do jogador.
    @guess_points = @stats[:total_attempts] > 1 ? GameRound.guess_points(@country.id) : []
  end
